  ...
  async execute(interaction, client) {
    ...
    if (interaction.customId == "open-ticket") {
      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const embed = new client.discord.MessageEmbed()
          ...
          .setFooter({text: '© 2023 Apple Development', iconURL: client.user.displayAvatarURL()})
          .setTimestamp();
    ...
    if (interaction.customId == "delete-ticket") {
      ...
      chan.messages.fetch().then(async (messages) => {
        ...
        if (a.length < 1) a = "Ticket was closed without any messages"
        var paste = new PrivateBinClient("https://privatebin.net/");
        var result = await paste.uploadContent(a, {uploadFormat: 'markdown'})
            const embed = new client.discord.MessageEmbed()
              .setAuthor({name: 'Ticket Logs', iconURL: client.user.displayAvatarURL()})
              ...
              .setColor('2f3136')
              .setFooter({text: "© 2023 Apple Development | This log will be deleted in 24 hrs!"})
              .setTimestamp();
